...
package com.example.specialeffectsandroid3.listitemscrolldel.view;
...
public class DragSortListView extends ListView {
     ...
     * move the check state from the item's old position to the new position 鈥�     * which is all fine and good (and removes the need for calling this
