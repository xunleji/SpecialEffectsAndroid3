...
public class Launcher extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String path = intent
				.getStringExtra("com.example.specialeffectsandroid3.listitemscrolldel");
		if (path == null) {
			path = "";
		}
	...
	protected List<Map<String, Object>> getData(String prefix) {
		...
		mainIntent
				.addCategory("com.example.specialeffectsandroid3.listitemscrolldel.sample.SAMPLE");
	...
	protected Intent browseIntent(String path) {
		...
		result.putExtra("com.example.specialeffectsandroid3.listitemscrolldel",
				path);
		return result;
	}
