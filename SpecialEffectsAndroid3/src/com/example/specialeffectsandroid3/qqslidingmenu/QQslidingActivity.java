...
import com.example.specialeffectsandroid3.qqslidingmenu.DragLayout.DragListener;
 ...
 * 
 */
public class QQslidingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_draglayout_main);
		initView();
		initDragLayout();
	}
	...
	private void initView() {
		...
		gv_img.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(QQslidingActivity.this,
						ImageActivity.class);
		...
		lv.setAdapter(new ArrayAdapter<String>(QQslidingActivity.this,
	...
	private void loadImage() {
		new Invoker(new Callback() {
			...
			public boolean onRun() {
				adapter.addAll(Util.getGalleryPhotos(QQslidingActivity.this));
			...
			public void onAfter(boolean b) {
				...
				if (b) {
					...
					Picasso.with(QQslidingActivity.this).load(s).into(iv_icon);
					Picasso.with(QQslidingActivity.this).load(s).into(iv_bottom);
				}
				shake();
			}
		}).start();
