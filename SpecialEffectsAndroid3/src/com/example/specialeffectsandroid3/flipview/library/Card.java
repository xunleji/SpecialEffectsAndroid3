...
package com.example.specialeffectsandroid3.flipview.library;
...
import static com.example.specialeffectsandroid3.flipview.library.TextureUtils.isValidTexture;
import static com.example.specialeffectsandroid3.flipview.library.FlipRenderer.checkError;
import static com.example.specialeffectsandroid3.flipview.library.TextureUtils.d2r;
import static com.example.specialeffectsandroid3.flipview.library.TextureUtils.toFloatBuffer;
import static com.example.specialeffectsandroid3.flipview.library.TextureUtils.toShortBuffer;
...
public class Card {
  ...
  public void draw(GL10 gl) {
    ...
    if (angle > 0) {
      ...
      if (axis == AXIS_TOP) {
        if (orientationVertical) {
          h = (cardVertices[Y_00] - cardVertices[Y_01]) * (1.0f -(float)Math.cos(d2r(angle)));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * (float)Math.sin(d2r(angle));
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (1.0f - (float)Math.cos(d2r(angle)));
          z = (cardVertices[X_10] - cardVertices[X_00]) * (float)Math.sin(d2r(angle));
          shadowVertices = new float[]{
        ...
        if (orientationVertical) {
          h = (cardVertices[Y_00] - cardVertices[Y_01]) * (1f - (float)Math.cos(d2r(angle)));
          z = (cardVertices[Y_00] - cardVertices[Y_01]) * (float)Math.sin(d2r(angle));
          shadowVertices = new float[]{
          ...
          w = (cardVertices[X_10] - cardVertices[X_00]) * (1f - (float)Math.cos(d2r(angle)));
          z = (cardVertices[X_10] - cardVertices[X_00]) * (float)Math.sin(d2r(angle));
          shadowVertices = new float[]{
              cardVertices[X_00], cardVertices[Y_00], 0f,
              cardVertices[X_01], cardVertices[Y_01], 0f,
