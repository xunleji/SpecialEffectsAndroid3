package com.example.specialeffectsandroid3.radarscan.library;
...
public class RadarScanView extends View {
	...
	private void init(AttributeSet attrs, Context context) {
		if (attrs != null) {
			...
			circleColor = ta.getColor(R.styleable.RadarScanView_circleColor,
					circleColor);
			radarColor = ta.getColor(R.styleable.RadarScanView_radarColor,
					radarColor);
			tailColor = ta.getColor(R.styleable.RadarScanView_tailColor,
					tailColor);
			ta.recycle();
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		Shader shader = new SweepGradient(centerX, centerY,
				Color.parseColor("#00A8D7A7"), Color.parseColor("#ffA8D7A7"));
